class Game{
    private _nome_do_jogo: string;
    private _ip_do_jogo

    constructor(_nome_do_jogo: string, _ip_do_jogo: string){
        this._nome_do_jogo = _nome_do_jogo;
        this._ip_do_jogo = _ip_do_jogo
    }

    get nome_do_jogo(): string{
        return this._nome_do_jogo
    }

    set nome_do_jogo(valor: string){
    ...
    set ip_do_jogo(valor_do_ip: string){
